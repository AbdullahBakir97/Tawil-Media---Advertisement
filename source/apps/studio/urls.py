...
urlpatterns = [
    ...
    path("advertising/", views.CampaignRequestListView.as_view(), name="campaign_requests"),
    path("advertising/rate-card/", views.RateCardListView.as_view(), name="rate_card"),
    path("advertising/media-kits/", views.MediaKitListView.as_view(), name="media_kits"),
